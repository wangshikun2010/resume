    ...
    <div data-role="content">
        ...
        <div data-role="collapsible-set" data-theme="c" data-content-theme="d" class="ui-collapsible-set">
            ...
            <div data-role="collapsible" data-inset="false" data-content-theme="c" data-iconpos="right" data-collapsed-icon="arrow-r" data-expanded-icon="arrow-d" id="skills">
                ...
                <ul>
                    <li>熟练运用<strong>HTML</strong>、<strong>CSS</strong>设计和美化网页，了解W3C标准，正在学习CSS3，HTML5；</li>
                    <li>熟悉<strong>Javascript</strong>及开源库jQuery，正在学习NodeJS；</li>
                    <li>了解<strong>BEM</strong>命名规则，了解LESS和SASS等预处理工具；</li>
                    <li>了解<strong>PHP</strong>的基本语法，能用PHP编写简单的动态网页；</li>
                    <li>熟练运用<strong>Sublime</strong>编写代码、<strong>Chrome</strong>调试代码；</li>
                    <li>熟悉<strong>版本控制</strong>系统SVN和Git的使用，了解Github和GoogleCode等服务；</li>
                    <li>能用<strong>Photoshop</strong>进行简单的平面设计和图像处理。</li>
                </ul>
            </div>

            <div data-role="collapsible" data-inset="false" data-content-theme="c" data-iconpos="right" data-collapsed-icon="arrow-r" data-expanded-icon="arrow-d" id="works">
            ...
            <div data-role="collapsible" data-inset="false" data-content-theme="c" data-iconpos="right" data-collapsed-icon="arrow-r" data-expanded-icon="arrow-d" id="projects">
                ...
                <div class="subsection">
                    <h3>
                        <span class="date span3">2013.07</span>
                        <span class="company">类Wunderlist日程管理应用</span>
                    </h3>
                    <ul>
                        <li>可方便用其进行待办事项的添加、编辑、删除（支持批量操作）；</li>
                        <li>使用Ajax进行数据接口调用，使用jQuery进行元素选取和事件处理；</li>
                        <li>使用的语言和技术：HTML5、CSS、Javascript、Ajax、jQuery。</li>
                    </ul>
                </div>
                <div class="subsection">
                    <h3>
            ...
            <div data-role="collapsible" data-inset="false" data-content-theme="c" data-iconpos="right" data-collapsed-icon="arrow-r" data-expanded-icon="arrow-d" id="education">
                ...
                <ul>
                    <li>2008.03~2011.03 &nbsp;&nbsp;&nbsp;&nbsp; 中专 &nbsp;&nbsp;&nbsp;&nbsp; 旬阳县职业中等专业学校 &nbsp;&nbsp;&nbsp;&nbsp; 电子专业</li>
                </ul>
            </div>
            ...
            <div data-role="collapsible" data-inset="false" data-content-theme="c" data-iconpos="right" data-collapsed-icon="arrow-r" data-expanded-icon="arrow-d" id="code">
                ...
                <div class="links">
                    ...
                    <a href="http://weibo.com/wangshikun2010" target="_blank">
                        <img src="img/weibo.png" alt="WeiBo" title="sina">
                    </a>
                    <a href="http://wenda.hiall.com.cn/u/wangshikun" target="_blank">
            ...
            <div data-role="collapsible" data-inset="false" data-content-theme="c" data-iconpos="right" data-collapsed-icon="arrow-r" data-expanded-icon="arrow-d" id="contact">
                ...
                <div class="row">
                    <p>邮箱：<a href="mailto:wangshikun2010@gmail.com">wangshikun2010@gmail.com</a></p>
                    <p>电话：<a href="tel:18810331153">188-1033-1153</a></p>
                </div>
            </div>
