...
<div class="container" id="main">
    ...
    <section id="basic" class="row">
        <div id="avatar" class="span2 visible-phone">
            <a href="javascript:void(0)" class="thumbnail">
                <img src="img/avatar.jpg" alt="" width="150" height="150"/>
            </a>
        </div>
        <div id="detail" class="span10">
            <h1>王仕军<small>（男）</small><span class="pull-right visible-desktop">求职意向：前端工程师</span></h1>
            <div class="row">
                <div class="span3">学历：硕士</div>
                <div class="span3">年龄：25</div>
                <div class="span3">政治面貌：中共党员</div>
            </div>
            <div class="row">
                <div class="span6">邮箱：<a href="mailto:wangshijun2010@gmail.com">wangshijun2010@gmail.com</a></div>
                <div class="span4">电话：<a href="tel:15811057083">158-1105-7083</a></div>
            </div>
            <div class="row">
                <div class="span6">业余爱好：计算机、音乐、烹饪</div>
                <div class="span4">毕业时间：2013-03</div>
            </div>
            <div class="row">
                <div class="span10">
                    通讯地址：北京市海淀区中关村南大街5号，北京理工大学新2号楼408室，100081
                </div>
            </div>
            <div class="row">
                <div class="span8 links">
                    ...
                    <a href="https://github.com/wangshijun2010" target="_blank">
                        <img src="img/github.png" alt="GitHub" title="我的GitHub">
                    </a>
                    <a href="http://weibo.com/wangshijun2010" target="_blank">
                        <img src="img/weibo.gif" alt="WeiBo" title="我的新浪微博">
                    </a>
                </div>
            </div>
        </div>
        <div id="avatar" class="span2 visible-desktop">
            <a href="javascript:void(0)" class="thumbnail">
                <img src="img/avatar.jpg" alt="" width="150" height="150"/>
            </a>
        </div>
    ...
    <section id="overview">
        ...
        <p>具有4年以上PHP开发经验，1年大型科技公司实习经验，8个以上中小项目设计和实施经验；具有良好的编码和重构习惯，熟悉面向对象和设计模式。<span class="label label-info">求职目标</span>为：PHP应用研发、WEB前端开发等技术应用类职务。</p>
    </section>
    ...
    <section id="internship">
        ...
        <div class="subsection">
            <h3>
                <span class="date span3"><strong class="visible-phone">时间：</strong>2012.07~2012.09</span>
                <span class="company span4"><strong class="visible-phone">公司：</strong>百度在线网络技术有限公司</span>
                <span class="department"><strong class="visible-phone">部门：</strong>贴吧技术部</span>
            </h3>
            <ul>
        ...
        <div class="subsection">
            <h3>
                <span class="date span3"><strong class="visible-phone">时间：</strong>2011.07~2012.06</span>
                <span class="company span4"><strong class="visible-phone">公司：</strong>淘宝（北京）技术有限公司</span>
                <span class="department"><strong class="visible-phone">部门：</strong>搜索应用研发部</span>
            </h3>
            <ul>
